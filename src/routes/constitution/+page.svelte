...
<div class="constitution">
    ...
    <p>4 IR Spots (Player must be labeled as IR, Out, Suspended, NA, DNR, Doubtful or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                ...
                <tr><td>TE</td><td class="right">No Max</td></tr>
            </table>
        </div>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process immediately and will be reversed if under investigation for collusion. Tradable assets include players, draft picks, and FAAB $.</p>
    ...
    <div class="subBlock">
        ...
        <p>The commissioner will err on the side of letting owners manage their teams the way they see fit. Any collusion will need to be clear. </p>
    </div>
    ...
    <div class="subBlock">
        <p>A total of 7 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion. Not liking a trade does not warrant a veto. Veto voting does not occur automatically. A trade is assumed valid unless protested. If you would like a collusion vote, notify me ASAP.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Wednesdays at 3AM EST.</p>

    <p>FAAB budgets will reset each season after the rookie draft.</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a linear draft. The first 6 picks will be based on maximum points possible for non playoff teams. The next 6 picks will be based on playoff results. Teams exiting in the same round will use seeding as a tiebreaker.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 4 round of drafting, with no firm time limit. Players drafted over the roster limit will be aquired, however, you will need to cut the necessary players to be able to make linup changes.</p>
    <p>Any spots not filled during the draft, can be filled immediately afterwards from the waiver wire.</p>
    
    <h3 bind:this={twoThree}>2.3 Draft Day Trades</h3>
    <p>Trades are allowed during the draft..</p>
    
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (the largest deviation is points for first downs instead of receptions). The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 14. The top 6 teams that finish with the best records, will receive a playoff berth. The top 2 teams will receive a bye week in the first round of the playoffs. Each playoff matchup prior to the championship will only last one week and the winner will advance. Championship matchup consists of weeks 16 & 17. Week 18 will not be used.</p>
    ...
    <p>Don't bother. Draft position is determined by best ball rules so benching your best players is pointless. Trade them away instead.</p>
    ...
    <p>In the event that multiple managers leave, we will do a dispercement draft for their replacements.</p>

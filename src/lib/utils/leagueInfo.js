/*   STEP 1   */
export const leagueID = "958461729803960320"; // your league ID
...
export const managers = [
    {
      ...
      "rival": {
        ...
        link: null, // manager array number within this array, or null to link back to all managers page, Index -1
      ...
      "philosophy": "Regular Season Champ, Playoff one and done",
    ...
    },
    {
      ...
      "favoritePlayer": 4022, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "QB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "All your QBs belong to me.",
      "tradingScale": 4, // 1 - 10
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Sportsball", // Can be anything (usually your rival's name)
      ...
      "favoritePlayer": 5670, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "TE", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Go Sportsball",
      "tradingScale": 1, // 1 - 10
